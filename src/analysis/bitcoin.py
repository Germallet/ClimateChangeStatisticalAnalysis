...
if __name__ == "__main__":
    ...
    utils.plot_all(annual_df.index, annual_df["BTCENEMAX"], "Date", "Annual electricity consumption (kWh)",
                   "Annual Bitcoin electricity consumption", "Annual Bitcoin electricity consumption")
